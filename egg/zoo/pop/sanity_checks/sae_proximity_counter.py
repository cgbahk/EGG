...
def get_sender(game_path, agent_idx=0):
    ...
    class DummyOpts:
        ...
        def __init__(self, game_path):
            ...
            self.vision_model_names_senders = (
                "['vit', 'inception', 'resnet152', 'vgg11', 'dino', 'swin', 'virtex']"
            )
            self.vision_model_names_recvs = (
                "['vit', 'inception', 'resnet152', 'vgg11', 'dino', 'swin', 'virtex']"
            )
...
def get_ims(dataset_name, n_examples, keep_dims):
    v_loader, t_loader = get_dataloader(
        ...
        else "/projects/colt/ILSVRC2012/ILSVRC2012_img_val/",
    ...
    mean = (
        ...
        else torch.tensor([0.5, 0.5, 0.5]).view(1, 3, 1, 1)
    )
    std = (
...
if __name__ == "__main__":
    ...
    print(
        f"Average number of ImageNet images closer to the closest CelebA image: {av_closer_c_im}"
    )
    ...
    print(
        f"Average number of ImageNet images closer to the closest Places205 image: {av_closer_p_im}"
    )
